...
// while (num <= 25) {
//     if (num % 2 === 0) {
//     console.log("Even # only! " + num);
// }
//     num +=1;
// }

// var correctFish = "sharkbait";
//
// var userPassword = prompt("What's the secret password???");
//
// while (userPassword !== correctFish) {
//
//     alert("Not the correct bait my guy");
// }
// alert("Welcome brother Sharkbait! Ooh Ha Ha");
