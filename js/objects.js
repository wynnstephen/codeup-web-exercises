    ...
    function hebDiscount(){
        shopper.forEach(function (shopper)){
            if (shopper.amount > 200){
                console.log(`${shopper.name}, for spending more that ${200}$ you receive a discount of 12% brining your total to 
                ${shopper.amount * (1-.12)}$`);
            } else {
                console.log(`${shopper.name}, you total is ${shopper.amount}$`)
            }
        }
    }

    console.log(hebDiscount())
